...
@section('breadcrumb')
    <x-breadcrumb pageone="Doctor" pageoneRoute="{{ route('doctorlist') }}" pagetwo="Edit" />
@endsection
@section('content')
    <main>
        <form action="{{ route('doctorprofile', $doctor->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                        ...
                        <div class="items-center sm:flex xl:block 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4">
                            <div class="justify-center text-gray-500 dark:text-gray-400">
                                ...
                                <div class="grid grid-cols-5 px-1 py-1  mt-5">
                                    ...
                                    <p class="col-span-3">{{ $doctor->username }}</p>
                                </div>
                                <div class="grid grid-cols-5 px-1 py-1  mt-5">
                                    <h4 class="col-span-2">Role</h4>
                                    <p class="col-span-3">admin</p>
                                </div>
                                <div class="grid grid-cols-5 px-1 py-1  mt-5">
                                    <h4 class="col-span-2">Designation</h4>
                                    <p class="col-span-3">admin</p>
                                </div>
                                <div class="grid grid-cols-5 px-1 py-1  mt-5">
                                    <h4 class="col-span-2">Email</h4>
                                    <p class="col-span-3">admin@gmail.com</p>
                                </div>
                                <div class="grid grid-cols-5 px-1 py-1  mt-5">
                                    <h4 class="col-span-2">Biodarta</h4>
                                    <p class="col-span-3">admin@gmail.com</p>
                                </div>
                ...
                <div class="col-span-2">
                    <div
                        ...
                        <div class="flex justify-between">
                            <div>
                                <h3 class="mb-4 text-xl font-semibold dark:text-white">Change your Profile!
                                </h3>
                            </div>
                            <div>
                                {{-- <a href="#"
                        ...
                        <x-form.input label="Name" name="name" value="" />
                        <x-form.input name="email" label="Email" type="email" disable="" value="" />
                        <x-form.input label="Phone" name="name" value="" />
