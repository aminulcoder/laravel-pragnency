...
<header class="sticky top-0 bg-white mynavbar z-50">
    <div class="container mx-auto flex items-center justify-between lg:py-2 py-2 px-3 lg:px-0">
        <div class="flex items-center space-x-6 ">
            <a href="#" class="flex-none text-xl font-semibold dark:text-white">
            ...
            <div class="space-y-2">
                <div class="flex items-center space-x-2">
                    <a href="#" class="sm:text-lg text-xl md:text-[22px] lg:text-2xl font-bold hover:text-brand">
                        Monodeep Samanta
                    </a>
                    <div class="hidden lg:flex items-center space-x-2">
                        ...
                        <div class="flex space-x-1 group">
                            <a href="#" class=" group-hover:text-yellow-400">
                        ...
                        <div>
                            <a href="#" class="text-base leading-[14px] font-medium text-black hover:text-brand">5.0
...
<section id="mymunebar" class=" hidden md:block  bg-white border-b px-4 2xlg:px-0 transition-all">
    <nav class="bg-white flex space-x-6 text-gray-400 container mx-auto">
        <a href="#"
            class=" border-b-2 border-b-[#FF003A] text-brand  inline-flex items-center gap-x-2 text-lg leading-[21px] whitespace-nowrap  focus:outline-none dark:text-blue-500 dark:focus:text-blue-400 menuhover pb-2 hover:text-brand">
            Home
        </a>
